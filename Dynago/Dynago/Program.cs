...
namespace Dynago {
    static class Program {
        ...
        public static string newestVersion = "4.1";
        public static string registeredMembers = "None";
        public static string currentUser = string.Empty;
        public static bool currentUserAds = false;

        private static NumberFormatInfo format = new System.Globalization.NumberFormatInfo() { NumberGroupSeparator = "." };
        private static string base_url = "https://github.com/Me-re-ly/oganyD";
        private static string base_url_justin = string.Empty;
        ...
        public static string url_adGenerate = string.Empty;
        public static string url_adCheck = string.Empty;
        public static string url_confuser = "http://github.com/Me-re-ly/oganyD/raw/master/Confuser/confuser.zip";
